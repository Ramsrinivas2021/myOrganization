...
SECRET_KEY = 'django-insecure-l&n5nul4!^#$bpf**xl%j72lh-xmct)*=dhse6fosd9-9m$al%'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'project.log',  # Specify the log file name and path
        },
    },
    'root': {
        'handlers': ['file'],
        'level': 'DEBUG',  # Adjust the desired root log level
    },
}
